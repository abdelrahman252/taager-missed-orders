...
const _STRINGS = {
  en: {
    ...
    "results.couldnt_process_btn": "Download Uncertain Orders",
    "results.couldnt_process_title": (n) => `Uncertain Orders — ${n} order${n !== 1 ? "s" : ""}`,
  ...
  ar: {
    ...
    "results.couldnt_process_btn": "تحميل الطلبات غير المؤكدة",
    "results.couldnt_process_title": (n) => `طلبات غير مؤكدة — ${n} ${n === 1 ? "طلب" : "طلبات"}`,
