...
window.renderSection1 = function (mountEl, data, ctx) {
  ...
  var newCards = [
    ...
    { label: s1Txt('Net Delivery Rate (NDR)', 'معدل التسليم الصافي (NDR)'), value: d.ndrRate ? d.ndrRate.value : (((window.dashboardGeoData || {}).pipeline || {}).metrics || {}).deliveryRate || 0, unit: '%', delta: d.ndrRate ? d.ndrRate.delta : 0, color: 'orange', spark: [], iconType: 'orange', tooltip: tx('kpi.ndrRate.tooltip', 'NDR = delivered orders / net placed orders.') },
