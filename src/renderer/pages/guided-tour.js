  ...
  function getSteps(page) {
    if (page === 'dashboard') return [
      ...
      dashboardStep('pipeline', 'pipeline', ['.s2-stage-row, .s2-funnel-scroll, .s2-metrics-grid'],
        'Status Pipeline Section', 'This section explains how orders move through the business. You can see stage totals, conversion movement, NDR outcomes, and where orders slow down or drop off.'),
      ...
      dashboardStep('gmvTarget', 'gmvTarget', ['.gmv-progress-card, .gmv-scenario-table, #gmv-target-input'],
        'GMV Target Planner Section', 'This section turns a Net Total Delivered Sales goal into daily placed-order pace, missing GMV, and run-rate scenarios based on NDR and delivered AOV.'),
