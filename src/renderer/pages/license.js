      ...
      <div style="width:460px;text-align:center;padding:0 20px">
        ...
        <div style="margin-bottom:28px;position:relative;display:inline-block">
          <div style="
            ...
            display:flex;align-items:center;justify-content:center;
            font-size:var(--type-hero);margin:0 auto;
            box-shadow:0 0 40px rgba(124,106,247,0.45);
            animation:lic-pulse 2.5s ease-in-out infinite;
          ">&#128274;</div>
        </div>

        <div style="font-size:var(--type-page-title);font-weight:var(--weight-bold);color:var(--text);margin-bottom:8px;letter-spacing:-0.5px">
          ${t("license.title")}
        </div>
        <div style="font-size:var(--type-control);color:var(--text2);line-height:1.6;margin-bottom:6px">
          ${t("license.subtitle")}
        </div>
        <div id="lic-days-badge" style="
          ...
          font-size:var(--type-caption);font-weight:var(--weight-semibold);letter-spacing:.08em;text-transform:uppercase;
          padding:4px 14px;border-radius:var(--radius-pill);margin-bottom:28px;
        "> </div>
        ...
        <div style="
          ...
          text-align:left;
        ">
          <label style="font-size:var(--type-caption);font-weight:var(--weight-semibold);color:var(--text2);text-transform:uppercase;letter-spacing:.07em;display:block;margin-bottom:10px">
            ${t("license.key_label")}
          </label>
          <input
            id="lic-input"
            ...
            style="
              ...
              font-size:var(--type-body);font-family:var(--font-mono);color:var(--text);
          ...
          <div id="lic-error" style="
            ...
            color:var(--danger);font-size:var(--type-label);font-weight:var(--weight-semibold);
            padding:8px 12px;background:rgba(255,77,109,0.1);
            border-radius:var(--radius-xs);border:1px solid rgba(255,77,109,0.25);
          "></div>
        </div>
        ...
        <button id="lic-btn" style="
          ...
          color:#fff;font-size:var(--type-component-title);font-weight:var(--weight-semibold);
        ...
        <button id="lic-support-btn" type="button" style="
          ...
          color:var(--text2);font-size:var(--type-control);font-weight:var(--weight-semibold);
        ...
        <div id="lic-restore-box" style="
          ...
          border-radius:var(--radius-sm);padding:14px;text-align:left;margin-bottom:16px;
        ">
          <div id="lic-restore-title" style="font-size:var(--type-control);font-weight:var(--weight-semibold);color:var(--text);margin-bottom:6px"></div>
          <div id="lic-restore-body" style="font-size:var(--type-label);color:var(--text2);line-height:1.5;margin-bottom:12px"></div>
          <div style="display:flex;gap:8px">
            <button id="lic-restore-btn" type="button" style="
              flex:1;padding:10px;border:none;border-radius:var(--radius-xs);cursor:pointer;
              background:#00b370;color:white;font-size:var(--type-control);font-weight:var(--weight-semibold);
            "></button>
            <button id="lic-skip-restore-btn" type="button" style="
              flex:1;padding:10px;border-radius:var(--radius-xs);cursor:pointer;
              background:transparent;border:1px solid var(--border);color:var(--text2);font-size:var(--type-control);font-weight:var(--weight-semibold);
            "></button>
          </div>
        </div>

        <div style="font-size:var(--type-caption);color:var(--text2);line-height:1.7">
